...
@pytest.mark.parametrize("text", ["Feat", "add_new_feature", "Add-New", "feat feat"])
...
@pytest.mark.parametrize("text", ["feat", "ADD NEW FEATURE", "add New feature", ""])
...
@pytest.mark.parametrize("text", ["Feat", "add-new-feature", "Add_New", "feat feat"])
...
@pytest.mark.parametrize("text,case_type,expected", [
...
def test_validate_dispatch(text: str, case_type: CaseType, expected: bool) -> None:
